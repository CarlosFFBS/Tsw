...
public class DadosCliente extends Dados implements InterfaceClienteSigns {
    ...
    public boolean verificaDuplicidadeClientePF(ClientePessoaFisica clientePF) throws Exception {
        ...
        stmt.setString(6, clientePF.getCidade());
        stmt.setString(7, clientePF.getEstado());
    ...
    @Override
    public int consultaCodClientePF(ClientePessoaFisica cliente) throws Exception {
        String sql = " SELECT Cli.cli_Codigo ";
    ...
    public int consultaCodClientePJ(ClientePessoaJuridica clientePJ) throws Exception {
        ...
        ResultSet rs = stmt.executeQuery();
        while (rs.next()) {
            clientePJ.setCli_Codigo(rs.getInt("cli_Codigo"));
        }
        return clientePJ.getCli_Codigo();
    }
    ...
    public boolean verificaDuplicidadeClientePJ(ClientePessoaJuridica clientePJ) throws Exception {
        ...
        stmt.setString(4, clientePJ.getBairro());
        stmt.setString(5, clientePJ.getCep());
        stmt.setString(6, clientePJ.getCidade());
        stmt.setString(7, clientePJ.getEstado());
        stmt.setString(8, clientePJ.getEmail());
        stmt.setString(9, clientePJ.getTelefone());
        stmt.setString(10, clientePJ.getCli_Cnpj());
        stmt.setString(11, clientePJ.getRazaoSocial());
        ...
        while (rs.next()) {
//            if ((rs.getString("Descricao").trim().equalsIgnoreCase(filtro.getDescricao().trim())) && (rs.getFloat("Preco") == filtro.getPreco())) {
//                retorno = true;
//            }
            retorno = true;
            break;
